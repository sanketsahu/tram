...
const FEATURES = [
  {
    ...
    body: 'For a real Expo app only ~8 MB of 539 MB is reachable into the bundle. tram splits the immutable vendor layer from the tiny mutable app layer and caches the vendor once.',
  },
  {
  ...
  },
  {
    ...
    body: 'Cost model: ~40–55 MB × N + one shared service, versus Metro’s ~325 MB × N idle and ~2 GB × N cold-bundle spikes. A burst of cold bundles is what OOMs a fleet node — tram removes it.',
  },
]
    ...
    <>
      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-6">
        ...
        <section className="flex flex-col items-center py-20 text-center sm:py-28">
          ...
          <p className="mt-6 max-w-2xl text-pretty text-lg text-muted-foreground">
            tram gives React Native a cross-project transform cache and a thin, no-Metro dev
          ...
          <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
            ...
            <Button asChild size="lg" variant="outline">
              <a href="https://github.com/sanketsahu/tram">Star on GitHub</a>
            </Button>
          </div>
        ...
        <section id="benchmark" className="scroll-mt-20 py-20">
          <div className="mx-auto mb-8 max-w-2xl text-center">
            ...
            <p className="mt-3 text-muted-foreground">
              ...
              zero sharing across servers. tram is measured against it on the same machine.
            </p>
          </div>
          <BenchmarkChart />
        </section>
      ...
      <footer className="border-t border-border/60">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-3 px-6 py-8 text-sm text-muted-foreground sm:flex-row">
          <span>tram — research WIP. Not affiliated with Meta, Expo, or the React Native team.</span>
          <div className="flex items-center gap-5">
            <Link href="/docs" className="hover:text-foreground">Docs</Link>
            <a href="https://github.com/sanketsahu/tram" className="hover:text-foreground">GitHub</a>
          </div>
        </div>
      </footer>
    </>
